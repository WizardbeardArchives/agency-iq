class RatesController < ApplicationController
  ...
  private
    ...
    def rate_params
      params.require(:rate).permit(:primaryKey, :RATE_STAFF, :RATE_CLIENT_NUM, :RATE_TASK, :RATE_KEY, :RATE_NOTE, :SPECIAL_RATE, :RATE_ADDED_BY, :RATE_ADDED_WHEN, :RATE_EDITED_BY, :RATE_EDITED_WHEN)
    end
end
