class StatementsController < ApplicationController
  ...
  private
    ...
    def statement_params
      params.require(:statement).permit(:primaryKey, :ST_DATE, :ST_AR_NUM, :ST_CK_NUM, :ST_CLIENT_NUM, :ST_TYPE, :ST_JOB_NUM, :ST_CHARGE_AMT, :ST_PMT_AMT, :ST_PO_NUM, :ST_DIVISION)
    end
end
